...
type AppConfig struct {
	...
	TokenExpiry    time.Duration `mapstructure:"tokenexpiry" validate:"required"`
	RequestTimeout time.Duration `mapstructure:"requesttimeout" validate:"required"`
}
...
type ObservabilityConfig struct {
	...
	OTLPEndpoint string `mapstructure:"otlpendpoint" validate:"required"`
}
